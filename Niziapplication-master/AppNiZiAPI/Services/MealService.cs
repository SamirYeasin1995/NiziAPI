...
namespace AppNiZiAPI.Services
{
    public interface IMealService
    {
        ...
        Task<Dictionary<ServiceDictionaryKey, object>> TryGetMeals(int patientId, HttpRequest req);
    ...
    class MealService:IMealService
    {
        ...
        async public Task<Dictionary<ServiceDictionaryKey, object>> TryGetMeals(int patientId, HttpRequest req)
        {
            Dictionary<ServiceDictionaryKey, object> dictionary = new Dictionary<ServiceDictionaryKey, object>();
            ...
            try
            {
                ...
                List<Meal> meals = await _mealRepository.GetMyMeals(patientId, minKcal, maxKcal);
